package pt.bamer.bamerosbuffer.utils;

public class Constantes {
    public static final String PREFS_NAME = "prefssharede";
    ...
    public static final String INTENT_EXTRA_BOSTAMP = "bostamp";
    public static final String INTENT_EXTRA_MODO_OPERACIONAL = "modo_operacional";

    public static final String PREF_VERSAO_VIEWS_COUCHBASE = "pref_versao_views_couchbase";
    ...
    public static final long TEMPO_MINIMO_PARAGEM_EM_MINUTOS = 20;
}
